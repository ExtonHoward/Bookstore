"""
A program that stores book info: Title, Author, Year, ISBN
User is able to: view all records, search, add, delete, update entry, close program
"""

#tkinter "END" function is not appearing to work for indexes. created workarounds in the different functions. 
...
#list box & scroll bar
list1 = tkinter.Listbox(window, height = 15, width = 80)
